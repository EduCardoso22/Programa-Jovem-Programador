...
FROM FUNCIONARIO
JOIN DEPARTAMENTO ON FUNCIONARIO.IDDEPARTAMENTO = DEPARTAMENTO.IDDEPARTAMENTO
WHERE DEPARTAMENTO.NOME = 'FINANCEIRO';

-- 2.

SELECT FUNCIONARIO.IDFUNCIONARIO, FUNCIONARIO.NOME, FUNCAO.NOME AS FUNCAO
FROM FUNCIONARIO
JOIN FUNCAO ON FUNCIONARIO.IDFUNCAO = FUNCAO.IDFUNCAO
WHERE FUNCAO.NOME LIKE '%ASSISTENTE%';

-- 3.

SELECT NOME, DTADMISSAO, SALARIO
FROM FUNCIONARIO
WHERE SALARIO > 1800;
...
SELECT FUNCIONARIO.IDFUNCIONARIO, FUNCIONARIO.NOME, FUNCIONARIO.SALARIO, DEPARTAMENTO.NOME AS DEPARTAMENTO, FUNCAO.NOME AS FUNCAO
FROM FUNCIONARIO
JOIN DEPARTAMENTO ON FUNCIONARIO.IDDEPARTAMENTO = DEPARTAMENTO.IDDEPARTAMENTO
JOIN FUNCAO ON FUNCIONARIO.IDFUNCAO = FUNCAO.IDFUNCAO;
...
SELECT SEXO, MAX(SALARIO) AS MAIOR_SALARIO, MIN(SALARIO) AS MENOR_SALARIO
FROM FUNCIONARIO
GROUP BY SEXO;

-- 7.

SELECT DEPARTAMENTO.IDDEPARTAMENTO, DEPARTAMENTO.NOME AS DEPARTAMENTO, 
       SUM(FUNCIONARIO.SALARIO) AS TOTAL_SALARIOS, 
       AVG(FUNCIONARIO.SALARIO) AS MEDIA_SALARIAL
FROM FUNCIONARIO
JOIN DEPARTAMENTO ON FUNCIONARIO.IDDEPARTAMENTO = DEPARTAMENTO.IDDEPARTAMENTO
GROUP BY DEPARTAMENTO.IDDEPARTAMENTO, DEPARTAMENTO.NOME;

-- 8.

SELECT DEPARTAMENTO.NOME AS DEPARTAMENTO, COUNT(FUNCIONARIO.IDFUNCIONARIO) AS TOTAL_FUNCIONARIOS
FROM FUNCIONARIO
JOIN DEPARTAMENTO ON FUNCIONARIO.IDDEPARTAMENTO = DEPARTAMENTO.IDDEPARTAMENTO
