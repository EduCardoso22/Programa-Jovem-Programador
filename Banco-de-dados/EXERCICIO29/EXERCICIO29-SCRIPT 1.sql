...
DROP DATABASE IF EXISTS DBEXERCICIO29;

CREATE DATABASE DBEXERCICIO29;
USE DBEXERCICIO29;
...
SELECT  DISTINCT IDCLIENTE, NOME, TELEFONE, DTNASCIMENTO
FROM VENDAS;

INSERT INTO PRODUTO (IDPRODUTO, DESCRICAO, PRECO)
SELECT DISTINCT IDPRODUTO, DESCRICAO, PRECO
FROM VENDAS;

INSERT INTO VENDA (IDVENDA, IDCLIENTE, IDPRODUTO, DT_VENDA)
SELECT DISTINCT IDVENDA, IDCLIENTE, IDPRODUTO, DT_VENDA
FROM VENDAS;

INSERT INTO ITEM_PEDIDO (IDVENDA, IDPRODUTO, PRECO, QTDE, TOTAL)
SELECT DISTINCT IDVENDA, IDPRODUTO, PRECO, QTDE, TOTAL
FROM VENDAS;
