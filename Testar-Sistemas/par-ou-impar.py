def par_ou_impar():
    ...
    escolha_jogador1 = input("Jogador 1, escolha se você quer par ou impar: ").strip().lower()
    while escolha_jogador1 not in ['par', 'impar']:
        escolha_jogador1 = input("Escolha inválida. Jogador 1, se você quer par ou impar: ").strip().lower()
