...
def NovoServico():
    ...
    tipo = input("Digite o tipo de serviço (ex: Acolhimento, Jurídico, etc.): ")
...
def DetalheServico(id):
    ...
    if servico:
        ...
        print(f"ID: {id_servico}, Tipo: {tipo}, Nome: {nome}, Endereço: {endereco}, Telefone: {telefone}")
    else:
...
def AlterarServico(id):
    ...
    if servico:
        ...
        novo_tipo = input("Digite o novo tipo de serviço (deixe em branco para não alterar): ") or tipo
        novo_nome = input("Digite o novo nome do serviço (deixe em branco para não alterar): ") or nome
        novo_endereco = input("Digite o novo endereço do serviço (deixe em branco para não alterar): ") or endereco
        novo_telefone = input("Digite o novo telefone do serviço (deixe em branco para não alterar): ") or telefone
